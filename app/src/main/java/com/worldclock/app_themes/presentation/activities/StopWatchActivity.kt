...
import com.worldclock.app_themes.presentation.adapter.LapTimeAdaptor
...
import com.worldclock.app_themes.core.utils.TimeFormatUtil
...
class StopWatchActivity : BaseActivity() {
    ...
    override fun onDestroy() {
        AppEventLogger.trackScreenDestroy(this, "StopwatchScreen")
        super.onDestroy()
        timer?.cancel()
    }
}